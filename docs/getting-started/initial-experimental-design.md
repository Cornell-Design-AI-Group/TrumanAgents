...
As a researcher, you can manipulate features of Truman Agents to fit the needs of your research.

## Research Question

Truman Agents can be used to study a variety of research questions. You can view past research that have used Truman [here](/docs/getting-started/citation-and-papers.md).

Once you have decided on your research question, begin to think about how Truman Agents can be used to facilitate studying your research question.

### Independent Variable

The variable that you manipulate is considered the **independent variable (IV)**.

Components of Truman Agents that can be readily manipulated for your experiment are:
...
A brief summary of the default data collected on Truman Agents is listed below. Decide which behaviors are applicable to your research question to measure as dependent variables:
...
| [Previous<br>Truman Agents](/docs/index.md) | [Next<br>Developing Your Simulation](/docs/getting-started/developing-your-simulation.md) |
| ------------------------------------------------- | ----------------------------------------------------------------------------------------- |
